...
import {
  ...
  Cpu, Download,
  Edit, Edit3, ExternalLink, Eye, EyeOff, File, FileCog, FileText, Film, Folder, FolderOpen,
  Gauge, GitBranch, Hash, HelpCircle,
  Home, Image, Info, Layers, Library, Link, List, Loader, LoaderCircle, Lock, LogIn, LogOut,
  Maximize, Menu, MoreHorizontal, MoreVertical, Move, Move3d, Music, Pause, Pencil,
  Play, Plus, Radio, RefreshCcw, RefreshCw, RotateCcw, Save, ScanLine, Search, Settings, Settings2,
  Shapes, Share2, Sparkles,
  Scissors, SkipBack, SkipForward, Sliders, Square, Star, StepBack, StepForward,
  Target, TrendingUp,
  Trash, Trash2, Upload, UploadCloud, User, Vibrate, Video, Volume2, VolumeX, X, Zap,
  ZoomIn, ZoomOut,
} from 'lucide-react';
...
const LUCIDE_MAP = {
  ...
  cpu: Cpu, download: Download, edit: Edit, 'edit-3': Edit3,
  gauge: Gauge,
  ...
  link: Link, list: List, loader: Loader, 'loader-circle': LoaderCircle,
  lock: Lock, 'log-in': LogIn, 'log-out': LogOut,
  ...
  'refresh-ccw': RefreshCcw, 'refresh-cw': RefreshCw, 'rotate-ccw': RotateCcw, save: Save,
  'scan-line': ScanLine, search: Search, settings: Settings, 'settings-2': Settings2,
  shapes: Shapes, sparkles: Sparkles,
  ...
  user: User, vibrate: Vibrate, video: Video,
